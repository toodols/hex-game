...
function CreateRoom(props: { expanded: boolean, set_expanded: (boolean) -> () })
	...
	return React.createElement("Frame", {
		...
		CreateRoomButton = React.createElement("TextButton", {
		...
		Content = if props.expanded
			then React.createElement("Frame", {
				...
				Dropdown = React.createElement(Dropdown, {
					...
					current = map_type,
					options = {
						my_map = React.createElement("TextLabel", {
							Text = "Standard",
							[React.Tag] = "subtitle",
						}),
						tutorial_map = React.createElement("TextLabel", {
							Text = "Tutorial",
							[React.Tag] = "subtitle",
						}),
						lightning = React.createElement("TextLabel", {
				...
				FinalizeButton = React.createElement("TextButton", {
					BackgroundTransparency = 1,
